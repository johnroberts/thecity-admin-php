...
class CityApi
{
    ...
    public $ssl_verify_peer = true; // Should curl verify it's SSL peer? Should be left true in production, 
    // you can set to false to in some test environments, like XAMPP on Windows
